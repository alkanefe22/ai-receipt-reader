...
| `review.png` | Detail panel of `northwind-invoice-no-majority.pdf`: date in *needs review* with A / B / arbiter chips; discount line kept by 2/3 |
...
| `multipage.png` | Detail panel of `northwind-invoice.pdf` (real recording): both PDF pages side by side with the 8 items read across them |
