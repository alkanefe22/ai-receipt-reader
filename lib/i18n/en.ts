export const en = {
  ...
  samples: {
    ...
    run: "Process",
    recordedTitle: "Real model recordings",
    recordedHint: "Actual outputs of local Ollama models, replayed",
    illustrativeTitle: "Scenario examples",
    illustrativeHint: "Hand-written responses for paths a live run doesn't produce on demand",
    scenario: {
      all_agreed: "Both models agree",
      arbiter_resolves: "Arbiter fixes a shifted amount",
      arbiter_fixes_name: "Arbiter fixes a misread name",
  ...
  detail: {
    ...
    seenBy: "Seen by",
    models: "Models",
    replay: "Hand-written example responses (no model called)",
    recorded: "Recorded real responses: {models} · {date} (no model called now)",
