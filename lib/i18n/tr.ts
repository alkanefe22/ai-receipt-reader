...
export const tr: Dictionary = {
  ...
  samples: {
    ...
    run: "İşle",
    recordedTitle: "Gerçek model kayıtları",
    recordedHint: "Yerel Ollama modellerinin gerçek çıktıları, tekrar oynatılıyor",
    illustrativeTitle: "Senaryo örnekleri",
    illustrativeHint: "Canlı çalışmada kendiliğinden oluşmayan durumlar için elle yazılmış cevaplar",
    scenario: {
      all_agreed: "İki model aynı değeri okuyor",
      arbiter_resolves: "Hakem kaymış tutarı düzeltiyor",
      arbiter_fixes_name: "Hakem yanlış okunan adı düzeltiyor",
  ...
  detail: {
    ...
    seenBy: "Görenler",
    models: "Modeller",
    replay: "Elle yazılmış örnek cevaplar (hiçbir model çağrılmadı)",
    recorded: "Gerçek model cevaplarının kaydı: {models} · {date} (şu an hiçbir model çağrılmadı)",
